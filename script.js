...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (contactForm) {
    ...
    function showError(input, message) {
      const fieldGroup = input.closest('.form-group, .field-group, .input-wrapper') || input.parentElement;
      
      let errorEl = fieldGroup.querySelector('.form-error');
      if (!errorEl) {
      ...
      if (!errorMessages[input.name]) {
        errorMessages[input.name] = errorEl;
      }
    }
    ...
    contactForm.addEventListener('input', function(e) {
      ...
      if (input.closest && input.closest('.contact-form') && input.classList.contains('input-error')) {
        clearError(input);
      }
    });
  }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '040527ef-1cb6-4e3a-9970-b0be7bf69870',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '040527ef-1cb6-4e3a-9970-b0be7bf69870';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '040527ef-1cb6-4e3a-9970-b0be7bf69870';
